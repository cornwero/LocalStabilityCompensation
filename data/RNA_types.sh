...
python figure_scripts/RNA_types.py bpRNA/hairpins.txt
python figure_scripts/RNA_types.py bpRNA/bulges.txt
python figure_scripts/RNA_types.py bpRNA/internalloops.txt

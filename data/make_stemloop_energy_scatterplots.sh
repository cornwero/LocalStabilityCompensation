...
python figure_scripts/stem_scatter.py False bpRNA/refold/hairpins.txt 0.2
python figure_scripts/stem_scatter.py False bpRNA/refold/bulges.txt 0.2
python figure_scripts/stem_scatter.py False bpRNA/refold/bulges.txt 0.2 no1nt
python figure_scripts/stem_scatter.py False bpRNA/refold/internalloops.txt 0.2

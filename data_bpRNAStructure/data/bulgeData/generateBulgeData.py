...
Description: Python script to gather bulge data for testing local energy compensation hypothesis using the bpRNAStructure module.

Usage: python3 bulgeLocalEnergy.py <RNA_Identifiers_File> <Input_Data_File> <Output_file_name>
...
def createOutputDataFile(Output_Data_File):
    with open(Output_Data_File, 'w') as f:
        headers = 'rna_name' + '\t' + 'rna_ID' + '\t' + 'rna_Type' + '\t' + 'bulgeLabel' + '\t' + 'bulgeLen'+ '\t' + 'bulgeEnergy' + '\t' + 'label5p' + '\t' + 'energy5p' + '\t' + 'label3p' + '\t' + 'energy3p' + '\n'

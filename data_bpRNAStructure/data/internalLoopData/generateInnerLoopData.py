...
Usage: python3 generateInnerLoopData.py <RNA_Identifiers_File> <Input_Data_File> <Output_file_name>
"""
...
sys.path.insert(0, '/nfs0/BB/Hendrix_Lab/bpRNA/LocalEnergy/bpRNAStructure/TurnerParameters/parameters')
sys.path.insert(0, '/users/michaelhathaway/HendrixLab/bpRNAStructure')
sys.path.insert(0, '/users/michaelhathaway/HendrixLab/bpRNAStructure/TurnerParameters/parameters')
...
def createOutputDataFile(Output_Data_File):
    with open(Output_Data_File, 'w') as f:
        headers = 'rna_name' + '\t' + 'rna_ID' + '\t' + 'rna_Type' + '\t' + 'internalLoopLabel' + '\t' + 'internalLoopEnergy' + '\t' + 'label5p' + '\t' + 'energy5p' + '\t' + 'label3p' + '\t' + 'energy3p' + '\n'

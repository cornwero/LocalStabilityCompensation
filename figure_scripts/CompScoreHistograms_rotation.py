...
def read_data(filename,IDs1m90,stemdict):
    data = []
    control = []
...
Hdata,Hcontrol = read_data(Hfile,d1m90,stems)
Bdata,Bcontrol = read_data(Bfile,d1m90,stems)
Idata, Icontrol = read_data(Ifile,d1m90,stems)
